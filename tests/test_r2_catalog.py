...
def test_r2_catalog():
    ...
    if not all([account_id, access_key, secret_key, bucket_name]):
        print("⚠ R2 credentials not configured. Skipping catalog test.")
    ...
    try:
        catalog = load_catalog(
            ...
            **{
                "type": "rest",
                "uri": f"https://{account_id}.r2.cloudflarestorage.com",
        ...
        try:
            ...
            print(f"✓ Found {len(tables)} table(s) in 'default' namespace")
